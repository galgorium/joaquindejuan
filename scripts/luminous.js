  ...
  (function (t) {
    ...
    function (t, i, e) {
      function n(t, i, e) {
        (i = void 0 === i ? {} : i),
          (e = void 0 === e ? {} : e),
          (this.f = Object.assign({}, { la: !0, M: null }, i)),
          (this.a = t),
          (this.b = e),
          (this.b._gallery = this),
          (this.b._arrowNavigation = this.f.arrowNavigation),
          this.h();
      }
      function o(t, i) {
        if (
      ...
      function s(t) {
        ...
        (this.h = this.a.G),
          (this.S = this.b("open")),
          (this.X = this.b("opening")),
          (this.U = this.b("closing")),
          (this.V = this.W = !1);
      }
      function h(t) {
        return (
      ...
      (s.prototype.L = function (t) {
        t && "function" == typeof t.preventDefault && t.preventDefault(),
          (t = this.a.F) && "function" == typeof t && t();
      }),
        (s.prototype.ba = function () {
          this.c.addEventListener(this.a.s, this.L),
            this.R && this.R.addEventListener("click", this.L);
        }),
        ...
        (s.prototype.ca = function () {
          ...
          a(t, this.b("lightbox-loader")),
            ...
            (this.j = document.createElement("img")),
            a(this.j, this.b("img")),
            t.appendChild(this.j),
            (this.m = document.createElement("p")),
            a(this.m, this.b("lightbox-caption")),
            t.appendChild(this.m),
            this.a.A &&
              ((this.R = document.createElement("div")),
              a(this.R, this.b("close-button")),
              this.c.appendChild(this.R)),
            this.a.i && this.da(),
            this.a.D.appendChild(this.c),
            this.P(),
            this.O(),
            this.a.B && this.j.classList.add("imgix-fluid");
        }),
        ...
        (s.prototype.g = function () {
          ...
          (t.width = this.f.clientWidth + "px"),
            ...
            (t.height = this.f.clientHeight - this.m.clientHeight + "px"),
            (t.maxHeight = this.f.clientHeight - this.m.clientHeight + "px");
        }),
        ...
        (s.prototype.open = function () {
          this.V || (this.ca(), this.ba(), (this.V = !0)),
            (this.h = this.a.G),
            this.P(),
            this.O(),
            a(this.c, this.S),
            ...
            u &&
              (this.c.addEventListener("animationend", this.v, !1),
              a(this.c, this.X));
        }),
        ...
        (s.prototype.v = function () {
          this.c.removeEventListener("animationend", this.v, !1),
            r(this.c, this.X);
        }),
        ...
        (o.prototype.open = function (t) {
          t && "function" == typeof t.preventDefault && t.preventDefault(),
            this.f.open(),
            this.a.Z && window.addEventListener("scroll", this.close, !1),
            (t = this.a.ja) && "function" == typeof t && t(),
            (this.h = !0);
        }),
        (o.prototype.close = function () {
          this.a.Z && window.removeEventListener("scroll", this.close, !1),
            this.f.close();
          var t = this.a.F;
        ...
        (o.prototype.u = function () {
          var t = this.a.fa;
          this.a.Y && (t = document.querySelector(this.a.Y)),
            (this.f = new s({
              C: this.a.C,
              D: t,
              G: this.b,
        ...
        (o.prototype.m = function () {
          this.b.addEventListener(this.a.aa, this.open, !1),
            this.a.$ && window.addEventListener("keyup", this.g, !1);
        }),
        (o.prototype.v = function () {
          this.b.removeEventListener(this.a.aa, this.open, !1),
            this.f.c && this.f.c.removeEventListener(this.a.s, this.close, !1),
            this.a.$ && window.removeEventListener("keyup", this.g, !1);
        }),
        ...
        (o.prototype.destroy = o.prototype.l),
        ...
        (n.prototype.destroy = n.prototype.l),
